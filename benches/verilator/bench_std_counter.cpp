/**
 * Verilator benchmark harness for std::counter (WIDTH=32).
 * Mirrors Celox benchmark_std_counter. Uses Google Benchmark for timing.
 *
...
// --- simulation_tick_std_counter_w32_x1 ---
...
BENCHMARK(BM_tick_x1)
    ->Name("simulation_tick_std_counter_w32_x1")
...
BENCHMARK(BM_tick_x1000000)
    ->Name("simulation_tick_std_counter_w32_x1000000")
...
BENCHMARK(BM_testbench_tick_x1000000)
    ->Name("testbench_tick_std_counter_w32_x1000000")
    ->UseManualTime()->Iterations(3)
    ->Unit(benchmark::kNanosecond);
