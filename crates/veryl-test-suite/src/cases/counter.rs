...
"#; }
        ...
        assert_eq!(
            ...
            (crate::BigUint::from(0u8), crate::BigUint::from(0u8))
        );
        assert_eq!(
        ...
        let first_value = crate::BigUint::from(0x3cu8);
        let first_mask = crate::BigUint::from(0x10u8);
        sim.modify(|io| {
            io.set(rst, 1u8);
        ...
        assert_eq!(
            sim.get_four_state(captured),
            (
                &first_value ^ crate::BigUint::from(0xa5u8),
                first_mask.clone(),
            )
        );
        assert_eq!(
        ...
        let second_value = crate::BigUint::from(0x52u8);
        let second_mask = crate::BigUint::from(0x03u8);
        sim.modify(|io| {
        ...
        assert_eq!(
            sim.get_four_state(captured),
            (
                &second_value ^ crate::BigUint::from(0xa5u8),
                second_mask,
            )
        );
        assert_eq!(
