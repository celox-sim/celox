...
pub(in crate::optimizer) struct ValueId(pub usize);

#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord)]
pub(in crate::optimizer) enum ValueOrigin {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord)]
pub(in crate::optimizer) struct StateToken {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::optimizer) enum ValueSafety {
    Pure,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::optimizer) enum ValueUse {
    Instruction {
        block: BlockId,
        index: usize,
        operand: usize,
...
pub(in crate::optimizer) struct ValueOccurrence {
    pub id: ValueId,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord)]
pub(in crate::optimizer) struct EffectId(pub usize);

#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord)]
pub(in crate::optimizer) enum EffectToken {
    Entry,
    Phi(BlockId),
    Occurrence(EffectId),
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::optimizer) enum EffectLocation {
    Instruction { block: BlockId, index: usize },
...
pub(in crate::optimizer) struct EffectOccurrence {
    pub id: EffectId,
...
#[derive(Clone, Debug)]
pub(in crate::optimizer) struct EffectPhi {
    pub block: BlockId,
...
pub(in crate::optimizer) struct PlacementBounds {
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub(in crate::optimizer) struct MaterializationFrontierCone {
...
#[derive(Debug)]
pub(in crate::optimizer) enum PlacementAnalysisError {
    InvalidSir,
    Cfg(SirCfgError),
    State(StateSsaError),
...
pub(in crate::optimizer) struct PlacementAnalysis {
    pub cfg: SirCfg,
