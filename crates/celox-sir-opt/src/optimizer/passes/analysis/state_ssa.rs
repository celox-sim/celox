...
pub(in crate::optimizer) enum StatePlane {
    TwoStateValue,
    FourStateValueAndMask,
}

impl StatePlane {
    pub(in crate::optimizer) fn for_type(ty: &RegisterType) -> Self {
        match ty {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, PartialOrd, Ord)]
pub(in crate::optimizer) struct StateFragment {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, PartialOrd, Ord)]
pub(in crate::optimizer) struct MemoryAccessId(pub usize);

pub(in crate::optimizer) type MemoryVersionId = MemoryAccessId;

#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::optimizer) enum MemoryAccessKind {
    LiveOnEntry,
    Use {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::optimizer) struct MemoryAccess {
...
#[derive(Debug, Clone)]
pub(in crate::optimizer) struct StateSsaSlot {
...
#[derive(Debug, Clone)]
pub(in crate::optimizer) struct StateSsa {
