...
pub(in crate::optimizer) struct GuardedRegionSinkingPass;
...
pub(in crate::optimizer) fn sink_pure_values_with_predicate_repair(
    eu: &mut ExecutionUnit<RegionedAbsoluteAddr>,
) {
    sink_pure_values_to_use_dominators(eu);
    loop {
...
/// live value.
pub(in crate::optimizer) fn eliminate_dead_control_regions(
    eu: &mut ExecutionUnit<RegionedAbsoluteAddr>,
) {
    loop {
