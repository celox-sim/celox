...
pub fn expression_signed(expr: &Expression) -> bool {
    match expr {
...
pub fn cast_semantics(source: &Expression, target: &Expression) -> Option<CastSemantics> {
...
pub fn resolve_binary_op(op: Op, lhs_signed: bool, rhs_signed: bool) -> BinaryOp {
    let signed = lhs_signed && rhs_signed;
    match op {
        Op::Add => BinaryOp::Add,
        Op::Sub => BinaryOp::Sub,
