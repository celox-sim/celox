...
use celox_frontend::veryl::VerylTestbenchSource;
...
pub(crate) fn project_observability(
    ...
    let (sites, read_variables) =
        celox_frontend::veryl::collect_testbench_observability(&program.frontend, source)?;
...
pub(crate) fn compile_semantic_testbench(
    ...
    celox_frontend::veryl::compile_semantic_testbench(
        &program.frontend,
        source,
