...
use crate::ir::{
    ...
    ModuleId, Program, RegionedAbsoluteAddr, RuntimeErrorInfo, SIRBuilder, SIRInstruction,
    SIROffset, SPARSE_WORKING_REGION, STABLE_REGION, SimModule, VarAtomBase, VariableInfo,
    WORKING_REGION,
};
